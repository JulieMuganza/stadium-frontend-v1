...
function Viewclient() {
  ...
  useEffect(() => {
    ...
    axios
      .get('https://stadium-backend-v1-production.up.railway.app/view')
      .then((response) => {
  ...
  const handleDelete = (id) => {
    axios
      .delete('https://stadium-backend-v1-production.up.railway.app/delete/' + id)
      .then((response) => {
  ...
  const handleDownload = async (id) => {
    try {
      const response = await axios.get(`https://stadium-backend-v1-production.up.railway.app/download/${id}`, {
      ...
      <div className="container-fluid mt-5">
        ...
        <div className="search-bar">
          ...
          <a
            ...
            onClick={() => navigate('/admin/viewsorted')}
          >
            {t('Sort by Name')}
          </a>
          <a
